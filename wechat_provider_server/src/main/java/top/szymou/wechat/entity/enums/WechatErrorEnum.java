...
public enum WechatErrorEnum {
    ...
    ERROR(-2, "未知错误"),
    USUAL_ERROR(-3, ""),
    ERROR_SELF(1047697114, "无需担心，自主出错"),
    ;

    private Integer errcode;
    private String desc;

    WechatErrorEnum(Integer errcode, String desc) {
        this.errcode = errcode;
        this.desc = desc;
    }

    public static WechatErrorEnum getByErrcode(int errcode) {
        for (WechatErrorEnum value : values()) {
